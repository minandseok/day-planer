...
export function CalendarDay({ date, isCurrentMonth, plans, onClick }: CalendarDayProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1 md:hidden">
        ...
        {plans.length > 3 && (
          <span className="text-[10px] text-gray-600 font-medium leading-none">+{plans.length - 3}</span>
        )}
      </div>
